...
// EtcdServer contains state for a Kubernetes cluster master/api server.
type EtcdServer struct {
	GenericAPIServer *genericapiserver.GenericAPIServer
	Operator         *controller.Controller
}

func (op *EtcdServer) Run(stopCh <-chan struct{}) error {
...
func (c *EtcdServerConfig) Complete() CompletedConfig {
...
// New returns a new instance of EtcdServer from the given config.
func (c completedConfig) New() (*EtcdServer, error) {
